...
/**
 * Interface to generate statements for specific DBMS 
 * implementations. 
 * 
 * @author rhodges
 *
...
public interface SqlDialect
{
  ...
  /** 
   * Returns true if this is the right implementation to use for the 
   * given JDBC URL. 
   */
  ...
  /** Returns a SELECT statement to fetch all rows and all colums. */
