...
public class DataGeneratorForDecimal implements DataGenerator
{
    ...
    // Logger.getLogger(DataGeneratorForDecimal.class);
    ...
    public Object generate()
    {
        ...
        /* Shift decimal to match precision, in order to avoid truncation issues */
        int placesRight = precision;
        // (int)(Math.random() * (double)(length + 1));
